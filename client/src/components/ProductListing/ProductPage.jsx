            ...
            {loading ? (
                ...
                <>
                    ...
                    <main className="mt-5 sm:mt-0">
                        ...
                        <div className="w-full flex flex-col lg:flex-row card p-2 relative">
                            {/* image wrapper */}
                            <div className="w-full lg:w-2/5 lg:sticky top-16 lg:h-screen">
                                {/* imgBox */}
                                <div className="flex flex-col gap-3 m-3 ">
                                    <div className="w-full lg:w-[450px] h-full pb-6 ring-1 ring-black/5 relative rounded-lg">
                                        <Slider {...settings}>
                                        ...
                                        <div
                                            className={`absolute top-4 right-4 shadow-lg bg-white/90 backdrop-blur w-9 h-9 border flex items-center justify-center rounded-full ${
                                                isAdmin ? "hidden" : ""
                                            } `}
                                        >
                                            <span
                                    ...
                                    <div className="w-full flex gap-3">
                                        ...
                                        {product.stock > 0 && (
                                            <button
                                                ...
                                                disabled={isAdmin}
                                                className="disabled:cursor-not-allowed p-2 sm:p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-[#ff9f00] rounded-md shadow hover:shadow-lg transition-colors"
                                            >
                                                <ShoppingCartIcon />
                                                {itemInCart
                                                    ? "GO TO CART"
                                        ...
                                        <button
                                            ...
                                            className={`disabled:cursor-not-allowed flex items-center justify-center gap-2 text-white rounded-md shadow hover:shadow-lg p-4 transition-colors ${
                                                product.stock < 1
                            ...
                            <div className="py-2 px-3 ">
                                ...
                                <div className="flex flex-col gap-3 mb-4">
                                    ...
                                    {["Flat ₹200 off on HDFC Bank Credit/Debit Card on 3 months EMI Txns, Min Txn Value ₹10,000","10% Instant Discount on ICICI Bank Credit Card Txns, up to ₹1250, on orders of ₹5000 and above","Flat ₹500 off on HDFC Bank Credit/Debit Card on 6 months EMI Txns, Min Txn Value ₹10,000"].map((el, i) => (
                                        <div
                                    ...
                                    <div className="flex gap-8 mt-2 items-center text-sm">
                                        <img
                                            draggable="false"
                                            className="w-20 h-8 p-0.5 ring-1 ring-black/5 rounded object-contain"
                                    ...
                                    <div className="w-full mt-4 pb-4 rounded-lg ring-1 ring-black/5 bg-white flex flex-col">
                                    ...
                                    {/* reviews border box */}
                                    <div className="w-full mt-4 rounded-lg ring-1 ring-black/5 bg-white flex flex-col">
                                        <div className="flex justify-between items-center border-b px-6 py-4">
                                            ...
                                            <button
                                                ...
                                                className="shadow bg-white font-[500] px-4 py-2 rounded-md hover:shadow-md border"
                                            >
                                                Rate Product
                                            </button>
                                        </div>
                                        ...
                                        {product.reviews?.length > 3 && (
                                            <button
                                                ...
                                                className="w-1/3 m-2 rounded-md shadow hover:shadow-lg py-2 bg-primary-blue text-white"
                                            >
